...
$keys = array();
$keys["area"] = postvalue("editid1");
$keys["jefatura"] = postvalue("editid2");
$keys["gestionSiges"] = postvalue("editid3");
$keys["correlativo"] = postvalue("editid4");
$keys["cantidadSolicitada"] = postvalue("editid5");
$keys["unidadDeMedida"] = postvalue("editid6");
$keys["descripcion"] = postvalue("editid7");
$keys["codigoInsumo"] = postvalue("editid8");
$keys["codigoPresentacion"] = postvalue("editid9");
$keys["existenciasAlmacen"] = postvalue("editid10");
